...
export const SYNONYM_GROUPS = [
  ...
  ["chips", "crisps", "snack", "zoutjes"],
  ["rookworst", "unox", "huls", "worst"],
  ["stamppot", "boerenkool", "hutspot", "andijvie", "zuurkool"],
  ["erwtensoep", "snert"],
  ["patat", "friet", "frites", "frituur"],
  ["kroket", "bitterbal", "frikandel", "snackbar"],
  ["stroopwafel", "stroopwafels"],
  ["hagelslag", "vlokken", "chocoladehagel"],
  ["pindakaas", "calve", "calvé"],
  ["filet", "americain", "ossenworst"],
  ["nasi", "bami", "goreng", "indisch"],
  ["shoarma", "gyros", "doner"],
  ["kibbeling", "lekkerbek"],
  ["ontbijtkoek", "peperkoek", "kruidkoek"],
  ["vla", "pudding", "toetje"],
  ["kwark", "skyr"],
  ["afhaal", "bezorg"],
];
