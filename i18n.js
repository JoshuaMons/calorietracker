...
export const ui = {
  ...
  home: {
    scheduleTitle: "Schema & doelen",
    startDate: "Startdatum schema",
    numDays: "Aantal dagen",
    dailyGoal: "Dagelijks calorie-doel",
    goalHint: "Kcal per dag (voor resterend budget en tips).",
    createSchedule: "Schema opslaan",
    useToday: "Vandaag",
    useTodayTitle: "Selecteert vandaag; schema blijft hetzelfde.",
    pickDay: "Kies een dag",
    daysCount: (n) => `${n} dagen`,
    summaryTitle: "Dagelijkse samenvatting",
